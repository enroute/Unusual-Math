...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}[scale=1]
    \draw(-6,0)--(6,0) arc (0:180:6);
    \draw[|<->|](-6,-0.6)--(3,-0.6) node[midway,fill=white]{$x_1$};
    \draw[|<->|](3,-0.6)--(6,-0.6) node[midway,fill=white]{$x_2$};
...
若上述条件扩展到任意实数，$a,b,c$一负两正，三负，则显然$abc<0$；但对
